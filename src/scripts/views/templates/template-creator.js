...
<div class="list_item">
            <img class="list_item_thumb lazyload" crossorigin="anonymous" src="${CONFIG.BASE_IMAGE_SMALL_URL + restaurant.pictureId}" alt="${restaurant.name}">
...
<div class="detail">
    <div class="detail-title">
        ...
        <img class="lazyload" crossorigin="anonymous" src="${CONFIG.BASE_IMAGE_MEDIUM_URL + restaurant.pictureId}" alt="${restaurant.name}" />
        <div class="info">
            <h2>Information</h2>
            <ul>
                <li>
